...
var teach = document.getElementsByClassName('teach')
...
function slide () {
  if (teachers === 0) { // Aziawa
    teach[0].style.display = 'block'
    setTimeout(function timeout () {
      teach[0].style.transition = 'transform 2s ease'
      teach[0].style.transform = 'translate(840px, 0)'
    }, 100)
  }
  if (classNumber === 1) { // Aoyama
    ...
    setTimeout(function timeout () {
      ...
      hero[1].style.transform = 'translate(750px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[2].style.transform = 'translate(500px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[3].style.transform = 'translate(500px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[9].style.transform = 'translate(600px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[10].style.transform = 'translate(400px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[11].style.transform = 'translate(350px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[12].style.transform = 'translate(500px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[13].style.transform = 'translate(460px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[14].style.transform = 'translate(600px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[15].style.transform = 'translate(400px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[16].style.transform = 'translate(600px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[17].style.transform = 'translate(400px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[18].style.transform = 'translate(500px, 0)'
    }, 100)
    ...
    setTimeout(function timeout () {
      ...
      hero[19].style.transform = 'translate(450px, 0)'
    }, 100)
  } else if (classNumber === 20) { // Momo
    hero[20].style.display = 'block'
    hero[20].style.marginLeft = '-700px'
    setTimeout(function timeout () {
      hero[20].style.transition = 'transform 2s ease'
      hero[20].style.transform = 'translate(560px, 0)'
    }, 100)
  }
}
function slideBack () {
